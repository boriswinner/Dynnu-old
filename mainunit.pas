...
begin
  ...
  CurrentTool.FigureCreate(CurrentTool.FigureClass,Point(X,Y),PenColor,BrushColor,PenStyle,BrushStyle);
  Invalidate;
end;
...
begin
  ...
  CurrentTool.FigureCreate(TRectangle,Point(0,0),clWhite,clWhite,psSolid,bsSolid);
